// ============================================================================
// SlimeRingBody.cs — 软体渲染桥：SlimeSimulation 粒子轮廓 → 动态 Mesh → 液态玻璃材质
// ============================================================================
...
namespace TransparentPet.Pet.Split
{
    ...
    public sealed class SlimeRingBody : MonoBehaviour
    {
        // MaterialPropertyBlock 的属性 ID 缓存（与 SlimeRing.shader 的 Properties 对应）
        ...
        /// <summary>当前使用的共享材质（分身创建时由 SplitPetController 传入主体的材质）。</summary>
            ...
            float dt)
        {
            ...
            // ── 写入材质属性（程序化眼睛已按用户要求彻底移除：史莱姆只做液态玻璃本体）──
