// ============================================================================
// SlimePbfMesh.cs — 2D PBF（Position Based Fluids）史莱姆粒子模拟
// ============================================================================
...
namespace TransparentPet.Pet.Shatter
{
    ...
    public struct PbfMeshEnvironment
    {
    ...
    public sealed class SlimePbfMesh
    {
        ...
        /// </summary>
        public SlimePbfMesh(Vector2 center, float halfWidth)
        {
            var spacing = Spacing;
        ...
        public void StepFrame(float dt, in PbfMeshEnvironment env)
        {
        ...
        void SubStep(float dt, in PbfMeshEnvironment env)
        {
            ApplyForces(dt, env);
            BuildNeighbors();
            ComputeLambda();
        ...
        void ApplyForces(float dt, in PbfMeshEnvironment env)
        {
            var h = EffectiveH;
            for (var i = 0; i < ParticleCount; i++)
            {
        ...
        void ProjectBounds(in PbfMeshEnvironment env)
        {
